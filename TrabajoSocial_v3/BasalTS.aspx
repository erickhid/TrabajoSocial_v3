<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="BasalTS.aspx.vb" Inherits="BasalTS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <style type="text/css">
        ...
        overflow: auto;
        width: 770px;
        height: 75px; /*establece la altura máxima, lo que no entre quedará por debajo y saldra la barra de scroll*/
        }
    </style>
    ...
    <div style="width: 770px; border: solid 1px #5d7b9d; text-align: left;">
        <div class="floating-menu">
            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    <asp:Button ID="btnCancelar" runat="server" Text="" CssClass="cancelar" PostBackUrl="~/BasalTS.aspx" />
            ...
            <ContentTemplate>
                ...
                <table id="tblbasal" runat="server" border="0" cellpadding="1" cellspacing="1" style="width: 770px;">
                    ...
                    <tr>
                        ...
                        <td style="width: 136px; background-color: #e9ecf1;">
                            <asp:DropDownList ID="ddl_circuito" runat="server" CssClass="ddl" TabIndex="3">
                    ...
                    <tr>
                        ...
                        <td style="width: 136px; background-color: #e9ecf1; padding: 0px;" colspan="5">
                            <asp:TextBox ID="txt_fecha_ES" runat="server" Width="70px" TabIndex="4"></asp:TextBox>
        ...
        <div>
            ...
            <td>
                <div style="border: solid 1px #5d7b9d;">
                    <%--Diseño de GridView Seguimiento--%>
                                        ...
                                        <table border="0" cellspacing="1" cellpadding="0" width="770px">
                                            <tr>
                                                ...
                                                <td style="text-align: right; width: 49px;" class="GV_rowpad">
                                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/add.png" OnClick="ibt_Agregar_Click" ToolTip="Agregar" TabIndex="11" />
                                                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/images/edit.png" OnClick="ibt_Modificar_Click" ToolTip="Modificar" Visible="false" TabIndex="12" style="width: 16px" />
                                                    <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/images/no.png" OnClick="ibt_Cancelar_Click" ToolTip="Cancelar" TabIndex="13" style="height: 16px" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div id="divingresoGF" runat="server" visible="false">
                                        <table border="0" cellspacing="1" cellpadding="0" width="770px">
                                            <tr>
                                                ...
                                                <td style="text-align: right; width: 49px;" class="GV_rowpad">
                                                    <asp:ImageButton ID="ibt_Agregar" runat="server" ImageUrl="~/images/add.png" ToolTip="Agregar" />
                                                    ...
                                                    <asp:ImageButton ID="ibt_Cancelar" runat="server" ImageUrl="~/images/no.png" OnClick="ibt_Cancelar_Click" ToolTip="Cancelar" style="height: 16px" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                    ...
                    <table border="0" cellspacing="1" cellpadding="0" width="770px">
                        <tr>
                            ...
                            <td style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                <asp:CheckBoxList ID="cbl_qsDx" runat="server" CellPadding="1" CellSpacing="1" RepeatDirection="Horizontal" RepeatLayout="Table" RepeatColumns="8" TabIndex="12"></asp:CheckBoxList>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <asp:Panel ID="pnl_CondicionesVivienda2" runat="server">
                <table id="Table1" border="0" cellpadding="1" cellspacing="1" style="width: 770px;">
                    <tr>
                        ...
                        <td style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                            <asp:CheckBoxList ID="cbl_tipovivienda" runat="server" CellPadding="1" CellSpacing="1" RepeatDirection="Horizontal" RepeatColumns="0" TabIndex="13"></asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 120px; background-color: #5d7b9d; color: #ffffff; padding-left: 4px;">Num. de Ambientes:</td>
                        <td style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                            <asp:TextBox ID="txt_nambientes" runat="server" Width="20px" CssClass="texto2" TabIndex="14"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 120px; background-color: #5d7b9d; color: #ffffff; padding-left: 4px;">Servicios:</td>
                        <td style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                            <asp:CheckBoxList ID="cbl_servicios" runat="server" CellPadding="1" CellSpacing="1" RepeatDirection="Horizontal" RepeatColumns="0" TabIndex="15"></asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 120px; background-color: #5d7b9d; color: #ffffff; padding-left: 4px;">Tipo Construcción:</td>
                        <td style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                            <asp:CheckBoxList ID="cbl_tipoconstruccion" runat="server" CellPadding="1" CellSpacing="1" RepeatDirection="Horizontal" RepeatColumns="7" TabIndex="16"></asp:CheckBoxList>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
        ...
        <div>
            <asp:Panel ID="pnl_IngresosEgresos2" runat="server">
                <asp:UpdatePanel ID="up_IngresosEgresos" runat="server" UpdateMode="Conditional" RenderMode="Block">
                    <ContentTemplate>
                        <table id="Table2" border="0" cellpadding="1" cellspacing="1" style="width: 770px;">
                            <tr>
                                <td colspan="6" style="padding-left: 2px; text-align: left; font-weight: bold;">INGRESOS:</td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 136px; background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>Q.&nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="txt_ingpersonal" runat="server" Width="75px" CssClass="texto4" AutoPostBack="True" TabIndex="17">0.00</asp:TextBox>
                                                <cc1:TextBoxWatermarkExtender ID="txt_ingpersonal_wm" runat="server" TargetControlID="txt_ingpersonal" WatermarkCssClass="wming" WatermarkText="0.00">
                                                </cc1:TextBoxWatermarkExtender>
                                ...
                                <td colspan="3" style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>Q.&nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="txt_inghogar" runat="server" Width="75px" CssClass="texto4" AutoPostBack="True" TabIndex="18">0.00</asp:TextBox>
                                                <cc1:TextBoxWatermarkExtender ID="txt_inghogar_wm" runat="server" TargetControlID="txt_inghogar" WatermarkCssClass="wming" WatermarkText="0.00">
                                                </cc1:TextBoxWatermarkExtender>
                                ...
                                <td style="width: 136px; background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>Q.&nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="txt_egvivienda" runat="server" Width="75px" CssClass="texto4" AutoPostBack="True" TabIndex="19">0.00</asp:TextBox>
                                                <cc1:TextBoxWatermarkExtender ID="txt_egvivienda_wm" runat="server" TargetControlID="txt_egvivienda" WatermarkCssClass="wming" WatermarkText="0.00">
                                                </cc1:TextBoxWatermarkExtender>
                                ...
                                <td style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>Q.&nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="txt_egeelectrica" runat="server" Width="75px" CssClass="texto4" AutoPostBack="True" TabIndex="20">0.00</asp:TextBox>
                                                <cc1:TextBoxWatermarkExtender ID="txt_egeelectrica_wm" runat="server" TargetControlID="txt_egeelectrica" WatermarkCssClass="wming" WatermarkText="0.00">
                                                </cc1:TextBoxWatermarkExtender>
                                ...
                                <td style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>Q.&nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="txt_egagua" runat="server" Width="75px" CssClass="texto4" AutoPostBack="True" TabIndex="21">0.00</asp:TextBox>
                                                <cc1:TextBoxWatermarkExtender ID="txt_egagua_wm" runat="server" TargetControlID="txt_egagua" WatermarkCssClass="wming" WatermarkText="0.00">
                                                </cc1:TextBoxWatermarkExtender>
                                ...
                                <td style="width: 136px; background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>Q.&nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="txt_egcable" runat="server" Width="75px" CssClass="texto4" AutoPostBack="True" TabIndex="22">0.00</asp:TextBox>
                                                <cc1:TextBoxWatermarkExtender ID="txt_egcable_wm" runat="server" TargetControlID="txt_egcable" WatermarkCssClass="wming" WatermarkText="0.00">
                                                </cc1:TextBoxWatermarkExtender>
                                ...
                                <td style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>Q.&nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="txt_egtelefono" runat="server" Width="75px" CssClass="texto4" AutoPostBack="True" TabIndex="23">0.00</asp:TextBox>
                                                <cc1:TextBoxWatermarkExtender ID="txt_egtelefono_wm" runat="server" TargetControlID="txt_egtelefono" WatermarkCssClass="wming" WatermarkText="0.00">
                                                </cc1:TextBoxWatermarkExtender>
                                ...
                                <td style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>Q.&nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="txt_egalimentacion" runat="server" Width="75px" CssClass="texto4" AutoPostBack="True" TabIndex="24">0.00</asp:TextBox>
                                                <cc1:TextBoxWatermarkExtender ID="txt_egalimentacion_wm" runat="server" TargetControlID="txt_egalimentacion" WatermarkCssClass="wming" WatermarkText="0.00">
                                                </cc1:TextBoxWatermarkExtender>
                                ...
                                <td style="width: 136px; background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>Q.&nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="txt_egtransporte" runat="server" Width="75px" CssClass="texto4" AutoPostBack="True" TabIndex="25">0.00</asp:TextBox>
                                                <cc1:TextBoxWatermarkExtender ID="txt_egtransporte_wm" runat="server" TargetControlID="txt_egtransporte" WatermarkCssClass="wming" WatermarkText="0.00">
                                                </cc1:TextBoxWatermarkExtender>
                                ...
                                <td style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>Q.&nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="txt_egeducacion" runat="server" Width="75px" CssClass="texto4" AutoPostBack="True" TabIndex="26">0.00</asp:TextBox>
                                                <cc1:TextBoxWatermarkExtender ID="txt_egeducacion_wm" runat="server" TargetControlID="txt_egeducacion" WatermarkCssClass="wming" WatermarkText="0.00">
                                                </cc1:TextBoxWatermarkExtender>
                                ...
                                <td style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>Q.&nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="txt_egbasura" runat="server" Width="75px" CssClass="texto4" AutoPostBack="True" TabIndex="27">0.00</asp:TextBox>
                                                <cc1:TextBoxWatermarkExtender ID="txt_egbasura_wm" runat="server" TargetControlID="txt_egbasura" WatermarkCssClass="wming" WatermarkText="0.00">
                                                </cc1:TextBoxWatermarkExtender>
                                ...
                                <td colspan="5" style="width: 136px; background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>Q.&nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="txt_egotros" runat="server" Width="75px" CssClass="texto4" AutoPostBack="True" TabIndex="28">0.00</asp:TextBox>
                                                <cc1:TextBoxWatermarkExtender ID="txt_egotros_wm" runat="server" TargetControlID="txt_egotros" WatermarkCssClass="wming" WatermarkText="0.00">
                                                </cc1:TextBoxWatermarkExtender>
        ...
        <table border="0" cellspacing="1" cellpadding="1" width="770px" style="border-top: 2px solid #5d7b9d;">
            <tr>
                ...
                <td style="background-color: #e9ecf1; padding-left: 2px; text-align: left;">
                    <asp:CheckBoxList ID="cbl_probidentificados" runat="server" CellPadding="1" CellSpacing="1" RepeatDirection="Horizontal" RepeatLayout="Table" RepeatColumns="5" TabIndex="29"></asp:CheckBoxList>
                </td>
            </tr>
            <tr>
